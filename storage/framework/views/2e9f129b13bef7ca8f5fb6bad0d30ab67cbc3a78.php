                ...
                <div class="col-3">
                    <div class="card h-100">
                        ...
                        <div class="card-body">
                            ...
                            'cancelButton("<?php echo e($client_id); ?>")'>キャンセル
                            </button>
                                                    ...
                                                    <div class="table-responsive container">
                                                        <table class="table table-striped">
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php if($record): ?>
                                                                        <?php echo e($record->settlement_date->format('Y-m-d')); ?>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    <?php if($record): ?>
                                                                        <?php echo e($record->proposal_date->format('Y-m-d')); ?> |
                                                                        <?php echo e($record->recognition_date->format('Y-m-d')); ?>
...
<?php echo $__env->make('layouts.blank-nav', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\waiton-dev\resources\views/host/individual-clients/video-creation.blade.php ENDPATH**/ ?>