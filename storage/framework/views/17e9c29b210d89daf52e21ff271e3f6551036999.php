                                ...
                                <table class="table table-hover table-bordered table-striped text-center">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td rowspan="2"><?php if($client->business_type_id == 1): ?> 法人 <?php else: ?> 個人 <?php endif; ?></td>
                                            <td rowspan="2"><?php echo e($client->tax_filing_month); ?>月</td>
                                            <td>
                                                <?php if($client->credentials): ?>
                                                    <?php echo e($client->credentials->nta_id); ?>
                                            ...
                                            <td>
                                                <?php if($client->credentials): ?>
                                                    <?php echo e($client->credentials->nta_password); ?>
                                        ...
                                        <tr>
                                            <td>
                                                <?php if($client->credentials): ?>
                                                    <?php echo e($client->credentials->el_tax_id); ?>
                                            ...
                                            <td>
                                                <?php if($client->credentials): ?>
                                                    <?php echo e($client->credentials->el_tax_password); ?>
...
<?php echo $__env->make('layouts.host', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/projects/waiton-dev/resources/views/host/client-list.blade.php ENDPATH**/ ?>