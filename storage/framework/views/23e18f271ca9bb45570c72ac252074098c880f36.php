                                        ...
                                        <tbody>
                                            ...
                                            <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo e($message->contents); ?></td>
                                                    <td class="text-info">
                                                        <?php if($message->file): ?>
                                                            <a href="<?php echo e(Storage::disk('gcs')->url($message->file->path)); ?>" download="<?php echo e($message->file->name); ?>"><?php echo e($message->file->name); ?></a>
                                                        <?php endif; ?>
                                                    </td>
                                                </tr>
...
<?php echo $__env->make('layouts.host-individual', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\waiton-dev\resources\views/host/individual-clients/message-client.blade.php ENDPATH**/ ?>