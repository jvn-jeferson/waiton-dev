                                            ...
                                            <tr>
                                                <td>
                                                    ...
                                                    <a class="btn btn-primary" type="button" data-toggle="tooltip"
                                                        ...
                                                        href="<?php echo e(route('access-data-financial-record', ['record_id' => $archive->id, 'client_id' => $hashids->encode($client->id)])); ?>">アクセス</a>
                                                </td>
                                                <td>
                                                    <?php echo e($archive->created_at); ?>
...
<?php echo $__env->make('layouts.host-individual', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/projects/waiton-dev/resources/views/host/individual-clients/financial-history.blade.php ENDPATH**/ ?>