    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="<?php echo e(route('client-home')); ?>" class="nav-link  <?php if(request()->route()->getName() == 'client-home'): ?> active  <?php endif; ?>">
          ...
          <li class="nav-item">
            <a href="data-incoming" class="nav-link <?php if(request()->route()->getName() == 'data-incoming'): ?> active  <?php endif; ?>">
              ...
              <p>
              From　会計事務所
                <span class="right badge badge-danger"><?php if($for_approval > 0): ?> <?php echo e($for_approval); ?> <?php endif; ?></span>
              </p>
            </a>
          </li>
          ...
          <li class="nav-item">
            <a href="settlement-history" class="nav-link <?php if(request()->route()->getName() == 'settlement-history'): ?> active  <?php endif; ?>">
          ...
          <li class="nav-item">
            <a href="notification-history" class="nav-link <?php if(request()->route()->getName() == 'notification-history'): ?> active  <?php endif; ?>">
...
<?php /**PATH C:\xampp\htdocs\waiton-dev\resources\views/layouts/client.blade.php ENDPATH**/ ?>