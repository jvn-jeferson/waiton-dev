                      ...
                      <ul class="list-group list-group-flush">
                        <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                          <li class="list-group-item">
                            ...
                            - <?php echo nl2br($message->contents); ?> <?php if($message->file): ?> <a href="<?php echo e(Storage::disk('gcs')->url($message->file->path)); ?>" download="<?php echo e($message->file->name); ?>"><i class="fa fas fa-paperclip"></i></a> <?php endif; ?>
                          </li>
                          ...
                          <?php $__empty_1 = true; $__currentLoopData = $downloads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $download): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                              ...
                              <td class="text-info">
                                ...
                                <a href="<?php echo e(Storage::disk('gcs')->url($download->file->path)); ?>" download="<?php echo e($download->file->name); ?>"><?php echo e($download->file->name ?? ''); ?></a>
                                <?php endif; ?>
                              </td>
                              <td>
                        ...
                        <tbody>
                          <?php $__empty_1 = true; $__currentLoopData = $files; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $file): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                            <tr>
                              ...
                              <td class="text-info"><a href="<?php echo e(url(Storage::disk('gcs')->url($file->path))); ?>" download="<?php echo e($file->name); ?>"><?php echo e($file->name); ?></a></td>
                              <td>
