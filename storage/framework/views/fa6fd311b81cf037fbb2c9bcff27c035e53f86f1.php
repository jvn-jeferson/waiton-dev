                        ...
                        <?php if(auth()->guard()->guest()): ?>
                            <?php if(Route::has('login')): ?>
                                <div class="dropdown mx-0">
                                    <button class="btn btn-primary dropdown-toggle" type="button" data-toggle="dropdown">ログイン
                                        <span class="caret"></span></button>
                                    <ul class="dropdown-menu">
                                        <li class='nav-link'><a
                                                href="<?php echo e(route('signin', ['user_type' => '会計事務所'])); ?>">会計事務所</a></li>
                                        <li class='nav-link'><a
                                                href="<?php echo e(route('signin', ['user_type' => 'クライアント'])); ?>">クライアント</a></li>
                                        <li class='nav-link'><a
                                                href="<?php echo e(route('signin', ['user_type' => 'モアジョブ'])); ?>">モアジョブ</a></li>
                                    </ul>
                                </div>
                            <?php endif; ?>
