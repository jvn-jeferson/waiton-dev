                                ...
                                <tbody>
                                    <?php $__empty_1 = true; $__currentLoopData = $materials; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $material): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            ...
                                            <td> <a href="#" onclick="downloadDocumentFiles(<?php echo e($material->pdf->id); ?>)"
                                                    role="button"><?php echo e($material->pdf->name); ?></a></td>
                                            <td> <a href="#"
                                                    onclick="downloadDocumentFiles(<?php echo e($material->document->id); ?>)"
    ...
    <?php $__env->startSection('extra-scripts'); ?>
        <script>
            function downloadDocumentFiles(id) {
                var url = "<?php echo e(route('download-client-files')); ?>"
...
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\laragon\www\waiton-dev\resources\views/client/material-storage.blade.php ENDPATH**/ ?>