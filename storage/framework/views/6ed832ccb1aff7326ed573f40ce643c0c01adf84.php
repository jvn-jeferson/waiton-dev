                                ...
                                <ul class="list-group list-group-flush">
                                  <?php $__empty_1 = true; $__currentLoopData = $messages; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $message): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <li class="list-group-item">
                                      ...
                                      - <?php echo nl2br(e($message->contents)); ?>  <?php if($message->file): ?> <a href="#" onclick="downloadFile(<?php echo e($message->file->id); ?>, this)"><i class="fa fas fa-paperclip"></i></a> <?php endif; ?>
                                    </li>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $uploads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upload): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td class="text-primary"><a href="#" onclick="downloadFile(<?php echo e($upload->file->id); ?>, this)"><?php echo e($upload->file->name); ?></a></td>
                                                <td>をアップロードしました。</td>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $downloads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $download): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                           <tr>
                                               ...
                                               <td class="text-info"><?php if($download->file): ?> <a href="#" onclick="downloadFile(<?php echo e($download->file->id); ?>, this)"><?php echo e($download->file->name ?? ''); ?><?php endif; ?></a></td>
                                               <td>
                                    ...
                                    <tbody>
                                        <?php $__empty_1 = true; $__currentLoopData = $uploads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upload): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                            <tr>
                                                ...
                                                <td><a href="#" onclick="downloadFile(<?php echo e($upload->file->name); ?>, this)"><?php echo e($upload->file->name); ?></a></td>
                                                <td>が保存されました。</td>
                                            </tr>
                                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); if ($__empty_1): ?>
                                            <tr>
...
<?php echo $__env->make('layouts.host-individual', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /opt/bitnami/projects/waiton-dev/resources/views/host/individual-clients/dashboard.blade.php ENDPATH**/ ?>