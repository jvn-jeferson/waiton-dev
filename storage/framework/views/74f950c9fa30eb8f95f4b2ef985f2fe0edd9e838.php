                                ...
                                <div class="table-responsive">
                                    <table class="table-striped table table-bordered">
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>利用者数</td>
                                                <td><?php echo e($account->staff->count()); ?> 社</td>
                                            </tr>
                                            <tr>
                                                <td>ご利用期日</td>
                                                <td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.host', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\waiton-dev\resources\views/host/account-management.blade.php ENDPATH**/ ?>