                            ...
                            <tbody class="text-center">
                                <?php $__empty_1 = true; $__currentLoopData = $uploads; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $upload): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                    <tr>
                                        ...
                                        <td>
                                            <?php if($upload->file): ?>
                                            <a href="<?php echo e(Storage::disk('gcs')->url($upload->file->path)); ?>" download="<?php echo e($upload->file->name); ?>" target="_blank"><?php echo e($upload->file->name); ?></a>
                                            <?php endif; ?>
                                        </td>
...
<?php $__env->stopSection(); ?>
<?php echo $__env->make('layouts.client', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\waiton-dev\resources\views/client/outgoing.blade.php ENDPATH**/ ?>